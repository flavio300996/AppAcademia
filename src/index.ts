...
await app.register(fastifySwagger, {
  openapi: {
    info: {
      ...
      description: "API para bootcamp de treinos",
      version: "1.0.0",
    },
    servers: [
      {
...
//Routes
await app.register(workoutPlanRoutes, { prefix: "/workoutPlans" });
await app.register(workoutSessionRoutes, { prefix: "/workoutSessions" });
